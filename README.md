...
Los pendientes de contenido de la página (créditos sin resolver, shows esperando link de entradas, etc.) son trackeo interno y NO se publican acá — quedan en `E:\SF\internal\pendientes_pagina.json`, fuera de este repo.
